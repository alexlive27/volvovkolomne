...
class Darx_Comments extends Darx_Parent {
	...
	/**
	 * Darx_Comments constructor.
	 */
	public function __construct()
    {
	    $this->module_slug = 'comments';
        // add sub-page
	...
	/**
	* Добавляет страницу Социальных комментариев в системный раздел Комментрии
	* и пункт меню для модуля "Комментарии"
	* Отображает настройки модуля "Комментарии"
	*/
    ...
    //TODO: отображение комментов с Фейсбука
	/**
	 * Отображение последних Социальных комментариев в системном разделе Комментрии
	 */
	...
	/**
	 * Регистрация настроек модуля "Комментарии"
	 */
	...
	/**
     * Создание метабокса с параметрами соц. комментариев
	 * @param $page
	 */
	...
	/**
	 * Содержимое метабокса с параметрами соц. комментариев
	 */
	...
	/**
     * Выполняется после сохранения поста. Если отключили соц. комментарии, то это записывается в мета-данные поста
	 * @param $post_id
	 */
	...
	/**
	 * подключение скриптов соцсетей для работы комментариев
	 */
	...
	/**
	 * Переназначает шаблон комментариев
     *
     * @param $file
	 *
	 * @return string
	...
	/**
     * Добавляет вкладки для виджетов комментриев под постом
     *
	 * @param $file
	 *
	 * @return mixed
	...
	public function add_tabs($file)
    {
        ...
        if( is_singular() && get_post_meta($post->ID, 'vkapi_comments', true) !== '0' ) {
            ...
            if( $count > 1 ) {
                ...
                add_action('add_tabs_button_action', function (){echo '</div>';}, 1024);
	...
	/**
	 * Заголовок вкладки комментариев ВК
	 */
	...
	/**
	 * Заголовок вкладки комментариев ФБ
	 */
	...
	/**
	 * Заголовок вкладки комментариев WP
	 */
	...
	/**
	 * Рендеринд виджета комментариев ВК
	 */
	...
	/**
	 * Рендеринд виджета комментариев ФБ
	 */
